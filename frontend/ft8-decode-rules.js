...
(function (root, factory) {
  ...
  function enrich(row, context={}) {
    ...
    return {
      ...
      newCountry:Boolean(country && !worked && !countryWorked),
      newDxcc:Boolean((dxcc||ctyEntity) && !worked && !dxccWorked),
      newDxccBand:Boolean((dxcc||ctyEntity) && band && !(worked && bands.includes(band)) && (!dxccWorked || !dxccBands.includes(band))),
      newDxccMode:Boolean((dxcc||ctyEntity) && mode && !(worked && modes.includes(mode)) && (!dxccWorked || !dxccModes.includes(mode))),
