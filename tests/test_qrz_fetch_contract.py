...
assert 'COUNT=%s' in c
for token in ['/api/v1/qrz/fetch','/api/v1/qrz/fetch/status','/api/v1/qrz/fetch/page','/api/v1/qrz/fetch/cancel','max:250']:
    assert token in js, token
for token in ['ft8-qrz-import','ft8-qrz-sync','ft8-qrz-cancel']:
